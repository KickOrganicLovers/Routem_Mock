...
export default function SignupCard() {
  ...
  return (
      <motion.div
          ...
          className="w-full h-full flex flex-col md:flex-row-reverse rounded-2xl text-foreground-0 "
      >
        ...
        <div className="w-full md:w-1/2 h-64 md:h-auto p-3 overflow-hidden flex flex-col justify-center items-center gap-6 @container">
            ...
            <h1 className={'text-8xl text-foreground-0 leading-snug text-center font-bold'}>Start your new <br /> adventure with us today!</h1>
            <div className={'flex flex-col gap-4 items-center'}>
                <h3 className={'w-fit text-foreground-0/60 font-bold text-2xl'}>Already Have Account?</h3>
                <Link href="/login">
                  <h3 className={'w-fit text-foreground-0 text-xl pb-1 px-2 border-b-2 border-foreground-0 hover:opacity-80 transition-opacity'}>Sign in →</h3>
                </Link>
            </div>
        </div>
        ...
        <div
          ...
          <div className="w-full max-w-sm space-y-8">
            <div className="text-center">
              ...
              <p className="mt-2 text-sm text-gray-600">Please enter your details to create an account.</p>
            </div>
